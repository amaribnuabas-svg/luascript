...
_G.ConfigFilePath = '/storage/emulated/0/Android/data/com.tencent.ig/files/KILLUMOD_MENU.ini'
...
local configTable1 = {
    '/storage/emulated/0/Android/data/com.tencent.ig/files/KILLUMOD_MENU.ini',
    '/storage/emulated/0/Android/data/com.pubg.krmobile/files/KILLUMOD_MENU.ini',
    '/storage/emulated/0/Android/data/com.vng.pubgmobile/files/KILLUMOD_MENU.ini',
    '/storage/emulated/0/Android/data/com.rekoo.pubgm/files/KILLUMOD_MENU.ini'
}
...
function _G.ShowAKMenu()
    ...
    local akmodpubgString = "KILLUMODPUBG"
            ...
            if self.Object == GameplayDataRef2 and not self.bHasShownExpiredNotice then
                if self.Object.IsAlive and self.Object:IsAlive() then
                    ...
                    pcall(function()
                        local logic_common_msg_box_1 = package.loaded["client.slua.logic.common.logic_common_msg_box"] or require("client.slua.logic.common.logic_common_msg_box")
                        if logic_common_msg_box_1 and logic_common_msg_box_1.Show then
                            logic_common_msg_box_1.Show(4, "MESSAGE FROM ADMIN KILLUMODPUBG", "YOUR MOD VERSION HAS EXPIRED\nPLEASE CONTACT TELEGRAM @KilluModsOfficial TO PURCHASE", function() 
                                local KismetSystemLibraryRef2 = import("KismetSystemLibrary")
                                if KismetSystemLibraryRef2 then KismetSystemLibraryRef2.LaunchURL("https://t.me/KilluModsOfficial") end
